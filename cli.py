"""
Command Line Interface for Clinical Llm Hallucination Critic.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="clinical-llm-hallucination-critic", description="Clinical Llm Hallucination Critic")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CLINICAL LLM HALLUCINATION CRITIC")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Clinical Llm Hallucination Critic Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Clinical Llm Hallucination Critic API server on http://{args.host}:{args.port}")
