"""
Data Models & Telemetry Definitions for MedFact-Critic: Clinical Fact-Checking & Citation Verification Agent.
Domain: Clinical NLP
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Natural Language Inference (NLI) Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
