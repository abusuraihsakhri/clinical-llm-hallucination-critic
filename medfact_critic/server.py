"""
FastAPI REST API Server for MedFact-Critic: Clinical Fact-Checking & Citation Verification Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="MedFact-Critic: Clinical Fact-Checking & Citation Verification Agent",
            description="Extracts clinical claims from LLM summaries, cross-referencing against structured EHR labs and calculating entailment scores.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "clinical-llm-hallucination-critic", "domain": "Clinical NLP", "version": "2.0.0-FRONTIER"}
