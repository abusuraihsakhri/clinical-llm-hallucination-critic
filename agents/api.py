"""
FastAPI REST API Server for Clinical Llm Hallucination Critic.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "clinical-llm-hallucination-critic", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
