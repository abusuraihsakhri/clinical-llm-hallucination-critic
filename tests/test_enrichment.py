"""
Automated Pytest for clinical-llm-hallucination-critic Enrichment Modules.
"""
import sys
...
from enrichment import (
    HallucinationTypeClassificationEngine,
    SourceVerificationEngine,
    HallucinationRateTrackingEngine,
    CriticCalibrationEngine,
    HallucinationMitigationSuggestionsEngine,
    ClinicalllmhallucinationcriticEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ClinicalllmhallucinationcriticEnrichmentSuite()
